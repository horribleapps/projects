...
search_string = sys.argv[1]#"50mL centrifuge tubes"  # Search string
download_folder = sys.argv[2]#"downloads/50mL_centrifuge_tube"  # Where to download images to
